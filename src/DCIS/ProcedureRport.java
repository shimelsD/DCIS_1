...
"Developer\n \tShimels Derso(+251940219818/shime4d@gmail.com) ", "About",1,Appointments.imgic);
   ...
   public void viewReport(){
         ...
         JasperReport jr =JasperCompileManager.compileReport("age agregated procedure report.jrxml");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProcedureRport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProcedureRport().setVisible(true);
            }
        });
    }
