...
public class ViewAndReportUsers extends JFrame {
    ...
    public void viewReport(){
        ...
        // JasperReport jr =JasperCompileManager.compileReport("UReport2.jrxml");
         JasperPrint jp=JasperFillManager.fillReport("UReport2.jasper", null,con);
...
"Developer\n \tShimels Derso(+251940219818/shime4d@gmail.com) ", "About",1,Appointments.imgic);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewAndReportUsers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewAndReportUsers().setVisible(true);
            }
        });
    }
